 ...
 */
struct llist *llist_create(void) { return calloc(1, sizeof(struct llist)); }
 ...
 */
int llist_count(struct llist *llist) { return llist->count; }
 ...
 */
void llist_array_free(void **a) { free(a); }
